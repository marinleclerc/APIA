    ...
    function buildResultsPage(_instance) {
      ...
      function addResult(
        ...
        function httpRequestCustomTest(portalId, term) {
          return new Promise(function(resolve, reject) {
            var SEARCH_URL =
              'https://api.hubapi.com/contentsearch/v2/search?portalId=62515&term=hubspot&type=BLOG_POST&length=SHORT',
      ...
      var getResults = (function() {
        if (getTerm()) {
          ...
          return httpRequestCustom('2659857', getTerm()).then(function(results) {
            data = results;
